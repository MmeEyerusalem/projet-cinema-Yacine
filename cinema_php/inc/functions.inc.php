...
define("RACINE_SITE", "/cinema_projet/cinema_php/"); // constante qui définit les dossiers dans lesquels se situe le site pour pouvoir déterminer des chemin absolus à partir de localhost (on ne prend pas locahost). Ainsi nous écrivons tous les chemins (exp : src, href) en absolus avec cette constante.
...
// ********************************* Fonction de sécurisation // une fonction de chaîne vers tableau

function stringToArray(string $string): array
{

    $array = explode('/', trim($string)); // je transforme ma chaîne de caractère en tableau et je supprime les "/" autour de la chaîne de caractère
...
///////////////// Fonction pour vérifier un utilisateur/////////////////////
    ...
    ///////////Une fonction pour récupérer et afficher tout les films///////////////
...
function showCata(int $id): mixed {
    $pdo = connexionBdd();
    ...
    //////////////////////////Fonction pour récupérer les films qui ont la même categories///////////////
    function filmByCategoryId(int $id) :array{
        $pdo = connexionBdd();
    ...
    ////////////////////////////function pour afficher les films récents////////////////////////////////
