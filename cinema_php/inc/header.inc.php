...
// if(strpos($_SERVER['REQUEST_URI'],"action=deconnexion")) {
//      $_SESSION['user']="";
//      session_destroy();
//      header("location:index.php");
//      }
// déconnecxion ($_SESSION)
...
<head>
     ...
     <!-- Font family -->
     <link href="https://fonts.googleapis.com/css2?family=Roboto+Condensed:wght@300;400;700&family=Roboto:wght@300;400;700;900&display=swap"
          rel="stylesheet">
     <!-- Icons Bootstrap -->
                         ...
                         <ul class="navbar-nav w-100 d-flex justify-content-end">
                              ...
                              <?php } else { ?>
                                   ...
                                   if ($_SESSION['user']['role'] == 'ROLE_ADMIN') {
                                        ...
                                        <li class="nav-item">
                                             <a class="nav-link"
                                                  href="<?= RACINE_SITE ?>admin/dashboard.php?dashboard_php">Backoffice</a>
                                        </li>
                              ...
                              <li class="nav-item">
                                   ...
                                   <a class="nav-link" href="<?= RACINE_SITE ?>boutique/panier.php"><i
